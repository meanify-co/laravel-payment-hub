            ...
            elseif($gateway == Constants::$PAGARME_GATEWAY_NAME)
            {
                ...
                if(isset($data->billing_address))
                {
                    $rules = array_merge($rules, [
                        ...
                        'billing_address.postal_code'    => 'required|regex:postal_code!'.(isset($data->billing_address->country_code) ? $data->billing_address->country_code : ''),
            ...
            elseif($gateway == Constants::$PAGARME_GATEWAY_NAME)
            {
                ...
                if(isset($data->billing_address))
                {
                    $rules = array_merge($rules, [
                        ...
                        'billing_address.complement'     => 'nullable',
                        'billing_address.postal_code'    => 'required_if:gateway_card_id,null|regex:postal_code!'.(isset($data->billing_address->country_code) ? $data->billing_address->country_code : ''),
